...
'''
nohup python -u main.py --base configs/SDSeg/cvc-ldm-kl-8-ccvim.yaml -t --gpus 0, --name cvc_no_pretrain > nohup/cvc_no_pretrain.log 2>&1 &
'''
...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        default = ['configs/SDSeg/cvc-ldm-kl-8_no_pretrain.yaml'],
